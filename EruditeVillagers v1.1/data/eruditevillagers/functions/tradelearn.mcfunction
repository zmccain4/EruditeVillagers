...
execute as @e[tag=bookenchantmentlearnable] at @s if entity @e[tag=book0,distance=0..1.25,nbt={Offers:{Recipes:[{sell:{tag:{StoredEnchantments:[]}}}]}},limit=1,sort=nearest] run tag @s add booklearnpending
...
# same for book1
execute as @e[tag=bookenchantmentlearnable] at @s if entity @e[tag=book1,tag=!book0,distance=0..1.25,nbt={Offers:{Recipes:[{sell:{tag:{StoredEnchantments:[]}}}]}},limit=1] run tag @s add booklearnpending
...
# same for book2
execute as @e[tag=bookenchantmentlearnable] at @s if entity @e[tag=book2,tag=!book0,tag=!book1,distance=0..1.25,nbt={Offers:{Recipes:[{sell:{tag:{StoredEnchantments:[]}}}]}},limit=1] run tag @s add booklearnpending
...
# same for book3
execute as @e[tag=bookenchantmentlearnable] at @s if entity @e[tag=book3,tag=!book0,tag=!book1,tag=!book2,distance=0..1.25,nbt={Offers:{Recipes:[{sell:{tag:{StoredEnchantments:[]}}}]}},limit=1] run tag @s add booklearnpending
...
# Identify Villager as having learned book4
